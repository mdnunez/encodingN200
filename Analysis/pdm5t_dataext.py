...
dataloc = '/media/michael/My Book/data4/pdm/exp5data/subjects/training/{0}/{1}/{0}_{1}_cleaned.mat'
saveloc = '/media/michael/My Book/data4/pdm/exp5data/subjects/training/{0}/{0}_allcleaned.npz'
...
for subdes in subjects:
    ...
    data['spfs'] = np.empty((480 * 7)) # Added 11-Aug-2023
