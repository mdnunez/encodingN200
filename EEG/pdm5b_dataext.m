function pdmdata = pdm5b_dataext(varargin)
%PDM5B_DATAEXT - Extracts cnt data and cleans photocells from PDM experiment4 and experiment 5
%
...
try
    for bnum = 1:nblocks
        ...
        block = pdm5b_filtereeg(tempdata,srate);
