...
# ====         ================                       ======================
# 12/11/17      Michael Nunez              Converted from hgs_ratcliffhdm.py
# 12/13/17      Michael Nunez        How well do percentiles recover values?
# 12/27/17      Michael Nunez          Incorporate 350 ms cutoff
# 12/28/17      Michael Nunez          Generate linear regressions, use 10th percentile
# 01/02/18      Michael Nunez     Scatter plots of changing slopes w/ mind wandering

#To do:
#1) Save last two figures
...
linearmodel = 'modelfits/trialparam_test_model%i.mat'
