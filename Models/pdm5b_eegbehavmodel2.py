# pdm5b_eegbehavmodel2.py - Creates models for training data of all subjects
...
# ====         ================                       ======================
# 01/26/18      Michael Nunez            Converted from pdm5b_eegbehavmodel1.py
...
for c in range(0, nchains):
    chaininit = {
        ...
        'tercond': np.random.uniform(0., .1, size=(2, nconds)),
