# pdm5b_eegbehavmodel3.py - Creates models for training data of all subjects
#                         with trial-by-trial N200 latencies, fast errors removed
#
#
...
# ====         ================                       ======================
# 01/29/18      Michael Nunez            Converted from pdm5b_eegbehavmodel1.py
...
trackvars = ['n1gammasub', 'n200sub', 'alphasub', 'deltasub', 'tersub',
             ...
             'n200trialsd', 'n1gammault', 'n1gammasd']
...
for c in range(0, nchains):
    ...
    for k in range(0, nconds):
        for j in range(0, nses):
            chaininit['tersub'][k, j] = np.random.uniform(0., minrt[k, j] - .1)
    initials.append(chaininit)

# Run JAGS model

# Choose JAGS model type
modelname = 'all_n200lat_random'
...
indata = data=dict(N=N, y=y, nses=nses, nconds=nconds,
