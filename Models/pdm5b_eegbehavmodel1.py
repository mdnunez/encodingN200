# pdm5b_eegbehavmodel1.py - Creates models for training data of all subjects
#                         with subject-level N1 latencies, fast errors removed
#
#
...
# ====         ================                       ======================
# 01/10/18      Michael Nunez            Converted from pdm5b_eegbehavmodel2.py
# 01/23/18      Michael Nunez        Fix variable "experiment" size and index
# 01/26/18      Michael Nunez                     Cleanup
...
for c in range(0, nchains):
    ...
    for k in range(0, nconds):
        for j in range(0, nses):
            chaininit['tersub'][k, j] = np.random.uniform(0., minrt[k, j])
    initials.append(chaininit)

# Run JAGS model

# Choose JAGS model type
modelname = 'all_n1lat_random'
...
indata = dict(N=N, y=y, nses=nses, nconds=nconds,
